...
OUTPUT_DIR="${OUTPUT_DIR:-examples/flavohemo_len396_refine}"
...
python scripts/design_sequence.py \
  ...
  --length 396 \
  --domain PF00042:27-130 \
  --domain PF00970:176-252 \
  --domain PF00175:264-372 \
  --step-aa 1 \
  ...
  --masked-char "?" \
  --masked-fill-aa A \
  --output-id flavohemo_len396_refine \
