#!/bin/bash
#SBATCH --job-name=design_pf00042
#SBATCH --output=logs/design_pf00042.out
#SBATCH --error=logs/design_pf00042.err
#SBATCH --time=1-00:00
...
OUTPUT_DIR="${OUTPUT_DIR:-examples/pf00042_len147_pfam27_142_refine}"
...
python scripts/design_sequence.py \
  ...
  --masked-char "?" \
  --masked-fill-aa A \
  --output-id pf00042_len147_pfam27_142_refine \
